...
Три ролика — записи реальных прогонов на **GLM-4.5-flash**, не постановка. Они
покрывают все три задачи-примера из ТЗ:

| ролик | задача из ТЗ | результат |
|---|---|---|
| [`demo.mp4`](demo.mp4) | 💼 Поиск вакансий — **реальный hh.ru** | 3 вакансии + сопроводительное, `completed` |
| [`demo-food.mp4`](demo-food.mp4) | 🍔 Заказ еды | корзина собрана, чекаут пройден, оплата **остановлена гейтом** |
| [`demo-mail.mp4`](demo-mail.mp4) | ✉️ Удаление спама | 4 спам-письма удалены, `completed` |

Модель — бесплатный тариф z.ai через Anthropic-совместимый эндпоинт.

### Первый прогон: демо-стенд
...
### Третий прогон: заказ еды и отказ в гейте

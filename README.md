...
Ниже — четыре записи настоящих прогонов: **два на живых публичных сайтах** и два на
локальном стенде. Не постановка: слева терминал, собранный из `trace.jsonl` прогона,
...
### 🛒 Покупка — на настоящем «Читай-городе»

> «Найди на этом сайте книгу «Мастер и Маргарита» в твёрдом переплёте, добавь её
> в корзину и покажи, что получилось: точное издание, издательство, цену и итоговую
> сумму в корзине.»

[![Покупка на Читай-городе](docs/img/case-shop.png)](demo-shop.mp4)

<sup>▶ **[demo-shop.mp4](demo-shop.mp4)** · 53 секунды · 14 шагов, `completed`</sup>

Изданий «Мастера и Маргариты» на сайте десятки — агент выбрал нужное, положил в корзину
и снял с неё цифры: издательство «Манн, Иванов и Фербер», 729 ₽ со скидкой 18 % от 889 ₽,
итого 729 ₽. Всё это есть в снапшоте страницы корзины — ничего не выдумано.

Страница корзины: **69 кликабельных элементов и 679 узлов, отброшенных как невидимые
или неинформативные**. Именно поэтому в контекст уезжает outline, а не HTML.

<br>

### 🍔 Заказ еды — и отказ в гейте

<sup>Локальный стенд: живые сервисы доставки режут автоматизацию на входе, а оформлять
настоящий заказ в чужом магазине — не то, что стоит делать ради демонстрации.</sup>

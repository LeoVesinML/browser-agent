...
Ниже — три записи настоящих прогонов. Не постановка: слева терминал, собранный из
`trace.jsonl` прогона, справа — запись того самого браузера, синхронно. Модель во всех
трёх — **GLM-4.5-flash**, самая дешёвая из доступных: тяжёлую работу делает не она, а
слой восприятия.
